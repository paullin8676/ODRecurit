...
const examPassLineRoutes = require('./routes/examPassLine');
const candidateRoutes = require('./routes/candidate');
const interviewStageRoutes = require('./routes/interviewStage');
...
app.use('/api/exam-pass-lines', examPassLineRoutes);
